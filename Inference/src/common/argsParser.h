...
inline bool parseArgs(Args& args, int argc, char* argv[])
{
    while (1)
    {
        ...
        static struct option long_options[] = {{"help", no_argument, 0, 'h'}, {"datadir", required_argument, 0, 'd'},
            ...
            {"useDLACore", required_argument, 0, 'u'}, {"batch", required_argument, 0, 'b'}, {"labeltxtfile", required_argument, 0, 'lb'},{nullptr, 0, nullptr, 0}};
        int option_index = 0;
        ...
        case 'lb':
            ...
            {
                std::cerr << "ERROR: --labeltxtfile requires option argument" << std::endl;
                return false;
            }
            break;
